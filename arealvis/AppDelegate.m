...
//    
//    for (DDXMLElement *channel in results) {
//        
//        NSLog(@"-----------");
//        
//        NSString *category = [[channel attributeForName:@"descr"] stringValue];
//        
//        NSLog(@"category:%@",category);
//        
//        for (int i = 0; i < [channel childCount]; i++) {
//            DDXMLNode *node = [channel childAtIndex:i];
//            NSString *name = [node name];
//            NSString *value = [node stringValue];
//            NSLog(@"%@:%@ %d",name,value, [node level]);
//        }
//    }
